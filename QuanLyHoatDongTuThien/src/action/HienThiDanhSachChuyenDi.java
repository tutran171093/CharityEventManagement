...
public class HienThiDanhSachChuyenDi extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		for (int i = 0; i < danhSachChuyenDiTrang.size(); i++) {
			...
			result += "<div class='post'><h5 class='title'><a href='chiTietBaiDang.do?maChuyenDi="
					+ baiDang.getMaBaiDang()
					+ "&trangSo=1' class='bold txthover'>"
					+ baiDang.getTieuDe()
					+ "</a></h5><div class='thumb'><a href='chiTietBaiDang.do?maChuyenDi="
					+ baiDang.getMaBaiDang()
					+ "&trangSo=1'><img src='"+baiDang.getUrlHinhAnh()+"' alt='' width='703px' height='200px' />"
					...
					+ "</p><a href='chiTietBaiDang.do?maChuyenDi="
					+ baiDang.getMaBaiDang()
