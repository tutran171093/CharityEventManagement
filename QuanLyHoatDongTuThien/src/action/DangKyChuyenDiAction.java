...
public class DangKyChuyenDiAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		new DangKyChuyenDiBO().dangKyChuyenDi(tenDangNhap, maChuyenDi);

		new ThongBaoBO()
				.themThongBao(
						tenDangNhap,
						"Bạn đã đăng ký tham gia chuyến đi <a href='chiTietBaiDang.do?trangSo=1&maChuyenDi="
