...
<body>
			...
			<div class="inner">
				...
				<div class="columns">
					...
					<div class="col1 left">
						<!-- Blog -->
						<div class="blog">
							<h4 class="heading backcolr">Danh sách các chuyến đi</h4>
							<!-- Post -->
							...
							<div class="paging">
								<ul class="left">
									...
									<bean:define id="trangSo" name="danhSachChuyenDiForm"
										property="trangSo" type="java.lang.String"></bean:define>

									<%
										int count = 1;
									%>
									<logic:iterate name="danhSachChuyenDiForm" property="soTrang"
										id="trang">
										<%
											count++;
										%>
									...
									<logic:iterate name="danhSachChuyenDiForm" property="soTrang"
										...
										<li><a id="<%=trang%>" class="backcolrhover"
											onclick="hienThiBinhLuan('<%=trang%>','<%=count%>')"> <bean:write
													name="trang" /></a></li>
									...
									<div class="tab_container_in">
										...
										<div id="blogswidget" class="tab_sidebar_list blogsc"
											...
											<ul style="width: 240px">
												<logic:iterate id="thanhVien" name="danhSachChuyenDiForm"
	...
	<script type="text/javascript">
		function hienThiBinhLuan(trang, i) {
			...
			$.ajax({
				type : "GET",
				url : "/QuanLyHoatDongTuThien/hienDanhSachChuyenDi.do?trang="
						+ trang,
